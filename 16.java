// Similar to 2Sum and 3Sum problems, however we cannot prune search space
// in the same way. See comments bellow.
    ...
    public int threeSumClosest(int[] num, int target) {
        ...
        for (int i = 0; i < num.length-2; i++) {
            ...
            for (int left = i+1, right = num.length-1; left < right; ) {
                ...
                // see this example: target = 107, num[i] = 1, left points to 5
                // and right points to 100 on the list below:
                // ... 5, 15, ..., 91, 100
